...
public class MicroCrudApplication extends  AbstractReactiveMongoConfiguration  {
	...
	private String db;
	 ...
	 @Bean
		...
		public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Documentation MICRO-CRUD API", "Documentation MICRO-CRUD AP", "1.0",
		...
		public Docket swaggerPersonApi10() {
			return new Docket(DocumentationType.SWAGGER_2)
					.select()
						.apis(RequestHandlerSelectors.basePackage("com.proyecto.everis.controller"))
